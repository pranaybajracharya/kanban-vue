<template>
  ...
  <div class="fill-height overflow-auto">
    <div class="d-flex ga-2">
      <KanbanColumn status="open" :tasks="openTasks" title="Open" />
      <KanbanColumn status="in-progress" :tasks="inProgressTasks" title="In Progress" />
      <KanbanColumn status="completed" :tasks="doneTasks" title="Completed" />
